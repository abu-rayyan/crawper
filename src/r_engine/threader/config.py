QUERIES = {
    ...
    "CheckCategories": "SELECT no_of_products FROM crawper.avg_word_length_category WHERE category_name=%s;",
    ...
    "InsertAvgWordLen": "INSERT INTO crawper.avg_word_length_category(category_name, avg_word_len, no_of_products)\
    VALUES (%s,%s, %s);" 
